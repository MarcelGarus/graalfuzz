...
public final class CoverageInstrument extends TruffleInstrument {
     ...
     * {@link Coverage coverage} data for that source. Coverage tracks loaded
     * and covered {@link SourceSection} during execution.
     */
     ...
     * inserted nodes will, once executed, remove the corresponding source
     * section from the {@link #coverageMap set of unexecuted source sections}.
     *
    ...
    /**
     * Called after a {@link SourceSection} is executed, and thus covered. We
     * can update our {@link #coverageMap}.
     *
